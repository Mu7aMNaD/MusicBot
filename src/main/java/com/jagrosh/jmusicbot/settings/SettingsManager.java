...
public class SettingsManager implements GuildSettingsManager
{
    ...
    public SettingsManager()
    {
        ...
        try {
            JSONObject loadedSettings = new JSONObject(new String(Files.readAllBytes(OtherUtil.getPath("serversettings.main"))));
    ...
    protected void writeSettings()
    {
        ...
        try {
            Files.write(OtherUtil.getPath("serversettings.main"), obj.toString(4).getBytes());
